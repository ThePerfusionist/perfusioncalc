...
[![Version](https://img.shields.io/badge/version-0.4.36-orange?style=flat-square)](https://github.com/ThePerfusionist/perfusioncalc/releases)
...
[![Tests](https://img.shields.io/badge/tests-297%20passing-brightgreen?style=flat-square)](test/)
...
**Dark is the default on first start, on every platform** — the app is used in
the operating theatre and in dimmed rooms, where a light screen is glaring.
Only the absence of a stored choice falls back to dark; anyone who picks
*System* or *Light* keeps it across restarts.
