...
class Strings {
  static const Map<String, Map<AppLocale, String>> _all = {
    ...
    'ped_title_va':           {AppLocale.en: 'V-A cannula size (Finck, APSA NaT)',
                               AppLocale.de: 'V-A Kanülengröße (Finck, APSA NaT)'},
    'ped_title_vv':           {AppLocale.en: 'V-V cannula size (Finck, APSA NaT)',
                               AppLocale.de: 'V-V Kanülengröße (Finck, APSA NaT)'},
