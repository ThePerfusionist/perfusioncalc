...
class Strings {
  static const Map<String, Map<AppLocale, String>> _all = {
    ...
    'cardio_timer_hint':       {AppLocale.en: 'Does not replace the perfusion record.',
                               AppLocale.de: 'Ersetzt nicht das Perfusionsprotokoll.'},


    // ── Timer alarm settings ─────────────────────────────────────────────────
    'cardio_alarm_off':        {AppLocale.en: 'off', AppLocale.de: 'aus'},
    ...
    'cardio_alarm_perm_missing': {AppLocale.en: 'Notifications are not permitted \u2013 tap to allow.',
                               AppLocale.de: 'Benachrichtigungen sind nicht erlaubt \u2013 zum Zulassen tippen.'},
    'cardio_alarm_grant':      {AppLocale.en: 'Allow notifications',
                               AppLocale.de: 'Benachrichtigungen zulassen'},
    'cardio_alarm_notif_title': {AppLocale.en: 'Cardioplegia re-dose',
                               AppLocale.de: 'Kardioplegie-Nachgabe'},
    'cardio_alarm_notif_body': {AppLocale.en: 'The configured interval since the last delivery has elapsed.',
                               AppLocale.de: 'Das eingestellte Intervall seit der letzten Gabe ist abgelaufen.'},
    ...
    'ped_transfusion_vol':    {AppLocale.en: 'Transfusion volume',
                               AppLocale.de: 'Transfusionsvolumen'},
    'ped_hct_in_ek':          {AppLocale.en: 'Hct of the RBC unit',
                               AppLocale.de: 'Hkt des Erythrozytenkonzentrats'},
    'ped_hct_ek_section':     {AppLocale.en: 'RBC concentrate (institutional setting)',
                               AppLocale.de: 'Erythrozytenkonzentrat (Einstellung der Einrichtung)'},
    'ped_hct_ek_hint':        {AppLocale.en: 'Saved permanently. Check against the unit label - the volume scales directly with this value.',
                               AppLocale.de: 'Wird dauerhaft gespeichert. Gegen das Etikett des Präparats prüfen - das Volumen skaliert direkt mit diesem Wert.'},
    'ped_hct_ek_default':     {AppLocale.en: 'Still the shipped default (55%). Davies 2007 used 0.60.',
                               AppLocale.de: 'Noch der Auslieferungswert (55%). Davies 2007 rechnete mit 0,60.'},
    'ped_hct_ek_reset':       {AppLocale.en: 'Reset to 55%',
                               AppLocale.de: 'Auf 55% zurücksetzen'},
    ...
    // ── BSA tab: expected values after hemodilution ───────────────────────
    'bsa_expected_hb_m':                   {AppLocale.en: 'Expected Hb (male)',
                               AppLocale.de: 'Erwarteter Hb (männlich)'},
    'bsa_expected_hb_f':                   {AppLocale.en: 'Expected Hb (female)',
                               AppLocale.de: 'Erwarteter Hb (weiblich)'},
    'bsa_bv_approx':                       {AppLocale.en: '(weight-based approximation)',
                               AppLocale.de: '(gewichtsbasierte Näherung)'},
    // ── In-app alert banner ───────────────────────────────────────────────
    'a11y_alert_banner':                   {AppLocale.en: 'Reminder',
                               AppLocale.de: 'Erinnerung'},
    // ── Source notes (SourceRef.noteKey) ──────────────────────────────────
    // One line each: what this source contributes to the app. Identifiers
    // (DOI/PMID/URL) stay in SourceRef.doi and are language independent.
    'src_note_eacts_kunst_2024':           {AppLocale.en: 'Default cardiac index 2.4 l/min/m² (adult CPB).',
                               AppLocale.de: 'Standardwert Cardiac Index 2,4 l/min/m² (adulte CPB).'},
    'src_note_silbernagl':                 {AppLocale.en: 'Simplified blood volume approximation from clinical perfusion practice.',
                               AppLocale.de: 'Vereinfachte Blutvolumen-Näherungsformel aus der klinischen Perfusionspraxis.'},
    'src_note_ranucci_2018':               {AppLocale.en: 'RCT on the goal-directed perfusion strategy.',
                               AppLocale.de: 'RCT zur GDP-Strategie.'},
    'src_note_gao_2023':                   {AppLocale.en: 'Meta-analysis, n = 777 from 3 RCTs.',
                               AppLocale.de: 'Metaanalyse, n = 777 aus 3 RCTs.'},
    'src_note_newland_2019':               {AppLocale.en: 'Multicentre ANZCPR study, n = 19,410.',
                               AppLocale.de: 'Multizentrische ANZCPR-Studie, n = 19.410.'},
    'src_note_nahas_1959':                 {AppLocale.en: 'TRIS buffer (tris-hydroxymethyl-aminomethane).',
                               AppLocale.de: 'TRIS-Puffer (Tris-Hydroxymethyl-Aminomethan).'},
    'src_note_adrogue_madias_2000':        {AppLocale.en: 'Sodium deficit calculation formula.',
                               AppLocale.de: 'Natrium-Defizit-Berechnungsformel.'},
    'src_note_gocol_2021':                 {AppLocale.en: 'Four-stage CPB hypothermia classification (mild/moderate/deep/profound).',
                               AppLocale.de: 'Vierstufige CPB-Hypothermie-Klassifikation (mild/mittel/tief/sehr tief).'},
    'src_note_hensley_2024':               {AppLocale.en: 'Modified ultrafiltration (MUF) reduces intraoperative red cell transfusions.',
                               AppLocale.de: 'Modifizierte Ultrafiltration (MUF) senkt intraoperative Erythrozytentransfusionen.'},
    'src_note_buckberg_1987':              {AppLocale.en: '4:1 blood:crystalloid cardioplegia, maintenance dose every 15–20 min.',
                               AppLocale.de: '4:1 Blut:Kristalloid-Kardioplegie, Erhaltungsdosis alle 15–20 min.'},
    'src_note_matte_del_nido_2012':        {AppLocale.en: '4:1 crystalloid:blood cardioplegia as a single dose.',
                               AppLocale.de: '4:1 Kristalloid:Blut-Kardioplegie als Einzeldosis.'},
    'src_note_gebhard_1984':               {AppLocale.en: 'Single versus intermittent HTK delivery.',
                               AppLocale.de: 'Einmalige vs. intermittierende HTK-Gabe.'},
    'src_note_huefner':                    {AppLocale.en: 'Historical original source of the haemoglobin O₂ binding capacity.',
                               AppLocale.de: 'Historische Originalquelle der Hämoglobin-O₂-Bindungskapazität.'},
    'src_note_dijkhuizen_1977':            {AppLocale.en: 'Modern validation of the Hüfner constant (β = 1.368 ml/g, n = 36).',
                               AppLocale.de: 'Moderne Validierung der Hüfner-Konstante (β = 1,368 ml/g, n = 36).'},
    'src_note_barrett_boyes':              {AppLocale.en: 'Factor 80 for converting SVR/PVR into dyn·s·cm⁻⁵.',
                               AppLocale.de: 'Faktor 80 für die SVR/PVR-Umrechnung in dyn·s·cm⁻⁵.'},
    'src_note_mellemgaard_astrup_1960':    {AppLocale.en: 'Base excess (BE) concept and the NaBic calculation formula.',
                               AppLocale.de: 'Base-Excess-Konzept (BE) und NaBic-Berechnungsformel.'},
    'src_note_severinghaus_1979':          {AppLocale.en: 'Eq. 1: O₂ dissociation curve · Eq. 2: PO₂ from SaO₂ · Eq. 3: temperature coefficient f_T.',
                               AppLocale.de: 'Gl. 1: O₂-Dissoziationskurve · Gl. 2: PO₂ aus SaO₂ · Gl. 3: Temperaturkoeffizient f_T.'},
    'src_note_bradley_severinghaus_1956':  {AppLocale.en: 'PCO₂ and PO₂ correction factors (f_CO₂ = 0.0185, f_O₂ = 0.0247).',
                               AppLocale.de: 'PCO₂- und PO₂-Korrekturfaktoren (f_CO₂ = 0,0185, f_O₂ = 0,0247).'},
    'src_note_severinghaus_1966':          {AppLocale.en: 'Henderson-Hasselbalch for blood: HCO₃⁻ = 0.0307 × PCO₂ × 10^(pH − 6.105).',
                               AppLocale.de: 'Henderson-Hasselbalch für Blut: HCO₃⁻ = 0,0307 × PCO₂ × 10^(pH − 6,105).'},
    'src_note_ashwood_1983':               {AppLocale.en: 'Critical review of all temperature correction formulas for pH, PCO₂ and PO₂.',
                               AppLocale.de: 'Kritische Überprüfung aller Temperaturkorrekturformeln für pH, PCO₂ und PO₂.'},
    'src_note_linderkamp_1977':            {AppLocale.en: 'Paediatric blood volume regression equations.',
                               AppLocale.de: 'Pädiatrische Blutvolumen-Regressionsgleichungen.'},
    'src_note_ramakrishnan_2023':          {AppLocale.en: 'Paediatric perfusion rates (high-flow/high-haematocrit).',
                               AppLocale.de: 'Pädiatrische Perfusionsraten (high-flow/high-hematocrit).'},
    'src_note_oldeen_2020':                {AppLocale.en: 'AmSECT guideline for paediatric and congenital perfusion.',
                               AppLocale.de: 'AmSECT-Leitlinie für pädiatrische und kongenitale Perfusion.'},
    'src_note_finck':                      {AppLocale.en: 'VA/VV cannula sizes for paediatric ECMO.',
                               AppLocale.de: 'VA/VV-Kanülengrößen für pädiatrische ECMO.'},
    'src_note_blausen_medical':            {AppLocale.en: 'Coronary vessels (anterior & posterior) and cardiac anatomy illustrations.',
                               AppLocale.de: 'Koronargefäße (anterior & posterior) und Herzanatomie-Abbildungen.'},
    'src_note_klineberg_1984':             {AppLocale.en: 'Mass conservation (Hct × volume = constant) for ultrafiltration/haemoconcentration.',
                               AppLocale.de: 'Massenerhaltung (Hkt × Volumen = konstant) für Ultrafiltration/Hämokonzentration.'},
    'src_note_calafiore_1995':             {AppLocale.en: 'Original paper on warm intermittent blood cardioplegia.',
                               AppLocale.de: 'Ursprungsarbeit der warmen intermittierenden Blutkardioplegie.'},
    'src_note_calafiore_2020':              {AppLocale.en: 'Modified Calafiore protocol (descending K⁺ dosing).',
                               AppLocale.de: 'Modifiziertes Calafiore-Protokoll (absteigende K⁺-Dosierung).'},
    'src_note_bretschneider_1980':         {AppLocale.en: 'Fundamentals of intracellular HTK cardioplegia.',
                               AppLocale.de: 'Grundlagen der intrazellulären HTK-Kardioplegie.'},
    'src_note_bretschneider_1975':         {AppLocale.en: 'Physiological and biochemical basis of ischaemia tolerance.',
                               AppLocale.de: 'Physiologische und biochemische Basis der Ischämietoleranz.'},
    // ── Plausibility range notes (Range.noteKey) ──────────────────────────
    'range_note_height':                   {AppLocale.en: 'Infants to gigantism',
                               AppLocale.de: 'Körpergröße Säuglinge bis Riesenwuchs'},
    'range_note_weight':                   {AppLocale.en: 'Neonates to extreme obesity',
                               AppLocale.de: 'Neugeborene bis adipositas permagna'},
    'range_note_pediatric_weight':         {AppLocale.en: 'Pediatric range',
                               AppLocale.de: 'Pädiatrischer Bereich'},
    'range_note_bsa':                      {AppLocale.en: 'Infant to very large adult',
                               AppLocale.de: 'Säugling bis sehr großer Erwachsener'},
    'range_note_hb':                       {AppLocale.en: 'Severe anemia to polycythemia',
                               AppLocale.de: 'Schwere Anämie bis Polyglobulie'},
    'range_note_hct':                      {AppLocale.en: 'Severe anemia to polycythemia',
                               AppLocale.de: 'Schwere Anämie bis Polyglobulie'},
    'range_note_priming_volume':           {AppLocale.en: 'Typically 1200–1800 ml adult, 300–600 ml pediatric',
                               AppLocale.de: 'Typisch 1200–1800 ml Adult, 300–600 ml Pädiatrie'},
    'range_note_circulating_volume':       {AppLocale.en: 'Patient\'s blood volume + priming, pediatric to adult',
                               AppLocale.de: 'Patientenblutvolumen + Priming, pädiatrisch bis adult'},
    'range_note_pa_o2':                    {AppLocale.en: 'Hypoxemia to ventilation with 100% O₂',
                               AppLocale.de: 'Hypoxämie bis 100% O2-Beatmung'},
    'range_note_pv_o2':                    {AppLocale.en: 'Mixed venous typically 35–45',
                               AppLocale.de: 'Gemischt-venös typisch 35–45'},
    'range_note_sa_o2':                    {AppLocale.en: 'Severe hypoxemia to normal',
                               AppLocale.de: 'Schwere Hypoxämie bis Normalbefund'},
    'range_note_sv_o2':                    {AppLocale.en: 'Normal 65–75%, critical <50%',
                               AppLocale.de: 'Normal 65–75%, kritisch <50%'},
    'range_note_co':                       {AppLocale.en: 'Shock to hyperdynamic state',
                               AppLocale.de: 'Schock bis Hyperdynamie'},
    'range_note_ci':                       {AppLocale.en: 'Normal 2.5–4.0',
                               AppLocale.de: 'Normal 2.5–4.0'},
    'range_note_map':                      {AppLocale.en: 'Normal 70–100',
                               AppLocale.de: 'Normal 70–100'},
    'range_note_cvp':                      {AppLocale.en: 'Normal 2–8',
                               AppLocale.de: 'Normal 2–8'},
    'range_note_pap':                      {AppLocale.en: 'Normal systolic 15–30',
                               AppLocale.de: 'Normal systolisch 15–30'},
    'range_note_lap':                      {AppLocale.en: 'Normal 6–12',
                               AppLocale.de: 'Normal 6–12'},
    'range_note_natrium':                  {AppLocale.en: 'Normal 135–145',
                               AppLocale.de: 'Normal 135–145'},
    'range_note_kalium':                   {AppLocale.en: 'Normal 3.5–5.0',
                               AppLocale.de: 'Normal 3.5–5.0'},
    'range_note_calzium':                  {AppLocale.en: 'Ionised Ca, normal 1.1–1.3',
                               AppLocale.de: 'Ionisiertes Ca, Normal 1.1–1.3'},
    'range_note_base_excess':              {AppLocale.en: 'Normal ±2',
                               AppLocale.de: 'Normal ±2'},
    'range_note_ph':                       {AppLocale.en: 'Normal 7.35–7.45',
                               AppLocale.de: 'Normal 7.35–7.45'},
    'range_note_temperature':              {AppLocale.en: 'Deep hypothermia to hyperthermia',
                               AppLocale.de: 'Tiefe Hypothermie bis Hyperthermie'},
    'range_note_tube_length':              {AppLocale.en: 'Usual lengths of CPB tubing sets',
                               AppLocale.de: 'Übliche Längen HLM-Schlauchsysteme'},
    'range_note_rbc_unit_hematocrit':      {AppLocale.en: 'German RBC units in additive solution: 50-70%',
                               AppLocale.de: 'Deutsche EK in Additivlösung: 50-70%'},
    'range_note_desired_hb_increase':      {AppLocale.en: 'Usual target Hb increment',
                               AppLocale.de: 'Üblicher Ziel-Hb-Anstieg'},
    'range_note_cardioplegia_dose_buckberg': {AppLocale.en: 'Induction/maintenance dose per Buckberg 1987',
                               AppLocale.de: 'Induktions-/Erhaltungsdosis nach Buckberg 1987'},
    'range_note_cardioplegia_dose_del_nido': {AppLocale.en: 'Single dose per Matte & del Nido 2012, max. 1000 ml',
                               AppLocale.de: 'Einzeldosis nach Matte & del Nido 2012, max. 1000 ml'},
    'range_note_cardioplegia_del_nido_crystalloid': {AppLocale.en: 'Crystalloid share (4 parts); blood follows with 1 part',
                               AppLocale.de: 'Kristalloidanteil (4 Teile); Blut folgt mit 1 Teil'},
    'range_note_cardioplegia_del_nido_pump_flow': {AppLocale.en: 'Crystalloid pump at 100%; blood pump follows proportionally',
                               AppLocale.de: 'Kristalloidpumpe 100 %; Blutpumpe folgt anteilig'},
    'range_note_cardioplegia_del_nido_cryst_percent': {AppLocale.en: 'Crystalloid share of the finished solution; 80% equals 4:1',
                               AppLocale.de: 'Kristalloidanteil der fertigen Lösung; 80 % entspricht 4:1'},
    'range_note_cardioplegia_calafiore_flow': {AppLocale.en: 'Pressure-controlled (e.g. 90–100 mmHg); flow-controlled reference protocol 200–300 ml/min',
                               AppLocale.de: 'Druckgesteuert (z.B. 90–100 mmHg); flusskontrolliertes Referenzprotokoll 200–300 ml/min'},
    'range_note_cardioplegia_calafiore_kcl_volume': {AppLocale.en: 'Institutional example: 40 ml KCl 14.9% (4 ampoules of 10 ml)',
                               AppLocale.de: 'Institutionelles Beispiel: 40 ml KCl 14,9 % (4 Ampullen à 10 ml)'},
    'range_note_cardioplegia_calafiore_mg_volume': {AppLocale.en: 'Optional. Institutional example: 10 ml MgSO₄ (1 ampoule of 10 ml)',
                               AppLocale.de: 'Optional. Institutionelles Beispiel: 10 ml MgSO4 (1 Ampulle à 10 ml)'},
    'range_note_cardioplegia_calafiore_kcl_conc': {AppLocale.en: 'KCl 14.9% equals 2 mmol/ml',
                               AppLocale.de: 'KCl 14,9 % entspricht 2 mmol/ml'},
    'range_note_cardioplegia_calafiore_kcl_conc_percent': {AppLocale.en: 'KCl 14.9% (standard) equals 2 mmol/ml',
                               AppLocale.de: 'KCl 14,9 % (Standard) entspricht 2 mmol/ml'},
    'range_note_cardioplegia_calafiore_mg_conc': {AppLocale.en: '500 mg/ml MgSO₄ heptahydrate equals 20 mmol per 10 ml ampoule (≈2.0 mmol/ml)',
                               AppLocale.de: '500 mg/ml MgSO4-Heptahydrat entspricht 20 mmol pro 10-ml-Ampulle (≈2,0 mmol/ml)'},
    'range_note_cardioplegia_calafiore_mg_conc_percent': {AppLocale.en: '500 mg/ml MgSO₄ heptahydrate is about 50% (w/v)',
                               AppLocale.de: '500 mg/ml MgSO4-Heptahydrat entspricht ca. 50 % (w/v)'},
    'range_note_cardioplegia_bretschneider_flow': {AppLocale.en: 'Pressure-controlled: initially 100–110 mmHg, 40–50 mmHg after arrest',
                               AppLocale.de: 'Druckgesteuert: initial 100–110 mmHg, nach Herzstillstand 40–50 mmHg'},
    'range_note_cardioplegia_bretschneider_time': {AppLocale.en: 'Initial perfusion 6–8 min, re-perfusion approx. 2–3 min',
                               AppLocale.de: 'Erstperfusion 6–8 min, Nachperfusion ca. 2–3 min'},
  };

  /// Read-only view of the full translation table.
  ///
  /// Exposed so a test can assert that every key exists in every locale -
  /// the previous i18n test checked six hand-picked keys while its own
  /// docstring promised full coverage, so a one-sided addition would have
  /// gone unnoticed.
  @visibleForTesting
  static Map<String, Map<AppLocale, String>> get all => _all;
