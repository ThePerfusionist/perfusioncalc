...
class Strings {
  static const Map<String, Map<AppLocale, String>> _all = {
    ...
    'cardio_capped_note':     {AppLocale.en: 'Volume capped at the maximum single dose of 1000 ml.',
                               AppLocale.de: 'Volumen auf die maximale Einzeldosis von 1000 ml begrenzt.'},
    ...
    'cardio_bret_ischemia':    {AppLocale.en: 'Ischemic protection up to ~180 min from a single administration \u2013 no re-infusion required within that window.',
                               AppLocale.de: 'Organprotektion bis ca. 180 min bei einmaliger Gabe \u2013 innerhalb dieses Fensters keine Re-Infusion erforderlich.'},
    'cardio_bret_phase':       {AppLocale.en: 'Perfusion phase',
                               AppLocale.de: 'Perfusionsphase'},
    'cardio_bret_phase_initial': {AppLocale.en: 'Initial',
                               AppLocale.de: 'Erstperfusion'},
    'cardio_bret_phase_reperfusion': {AppLocale.en: 'Re-perfusion',
                               AppLocale.de: 'Nachperfusion'},
    'cardio_bret_guidance_initial': {AppLocale.en: 'Induction: 6\u20138 min. Protocol perfusion pressure initially 100\u2013110 mmHg \u2013 observe the institutional delivery-pressure limits above.',
                               AppLocale.de: 'Induktion: 6\u20138 min. Protokoll-Perfusionsdruck initial 100\u2013110 mmHg \u2013 institutionelle Applikationsdruck-Grenzen oben beachten.'},
    'cardio_bret_guidance_reperfusion': {AppLocale.en: 'Re-perfusion: 2\u20133 min. After cardiac arrest the perfusion pressure is reduced to 40\u201350 mmHg.',
                               AppLocale.de: 'Nachperfusion: 2\u20133 min. Nach Herzstillstand wird der Perfusionsdruck auf 40\u201350 mmHg reduziert.'},
